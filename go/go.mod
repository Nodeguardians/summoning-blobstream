...
require (
	...
	github.com/succinctlabs/blobstreamx v0.0.0-20240404022756-694781f814a1
...
replace (
	github.com/cometbft/cometbft => github.com/celestiaorg/celestia-core v1.35.0-tm-v0.34.29
